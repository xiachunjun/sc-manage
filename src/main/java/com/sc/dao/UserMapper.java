...
public interface UserMapper {
    ...
    @Insert({
        "insert into sc_users (id, user_login_name, ",
        "user_login_pwd, user_id_card, ",
        "user_name, user_nickname, ",
        "data_state, data_version, ",
        "create_user, update_user, ",
        "create_time, update_time)",
        "values (#{id,jdbcType=INTEGER}, #{userLoginName,jdbcType=VARCHAR}, ",
        "#{userLoginPwd,jdbcType=VARCHAR}, #{userIdCard,jdbcType=VARCHAR}, ",
    ...
    @Select({
        "select",
        "id, user_login_name, user_login_pwd, user_id_card, user_name, user_nickname, ",
    ...
    @Select({
        ...
        "data_state, data_version, create_user, update_user, create_time, update_time",
        "from sc_users",
        "where  user_login_name = #{userLoginName,jdbcType=INTEGER}"
    })
    @Results({
        @Result(column="id", property="id", jdbcType=JdbcType.INTEGER, id=true),
        @Result(column="user_login_name", property="userLoginName", jdbcType=JdbcType.VARCHAR),
    ...
    UserDomain queryByLoginName(@Param("userLoginName")String userLoginName);
    
    
	@Update({ 
		"update sc_users", 
		"set user_login_pwd = #{userLoginPwd,jdbcType=VARCHAR},",
		"update_time = now() ",
		" where id = #{id,jdbcType=INTEGER}" 
		})
	int updatePwd(@Param("id") Integer id,@Param("userLoginPwd") String userLoginPwd);
