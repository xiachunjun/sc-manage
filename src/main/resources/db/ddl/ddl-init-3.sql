...
CREATE TABLE `sc_plans` (
	`id` int(11) NOT NULL AUTO_INCREMENT,
	`ref_dept` varchar(50) DEFAULT NULL COMMENT '所属部门',
	`ref_user` varchar(50) DEFAULT NULL COMMENT '责任人',
	`ref_position` varchar(50) DEFAULT NULL COMMENT '岗位',
	...
	`data_state` int(11) DEFAULT NULL COMMENT '0-失效；1-初始',
	`data_version` int(11) DEFAULT NULL,
